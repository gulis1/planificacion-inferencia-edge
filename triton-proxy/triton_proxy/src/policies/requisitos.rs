...
// use triton_proxy_lib::{model::Model, policy::{Policy, Request, RequestContext}, server::{Endpoint, Endpoints}};
// use uuid::Uuid;
...
// #[derive(Debug, Clone)]
// struct RequisitosContext {
//     pub tiempo_min: u32,
//     pub precision_min: u32
// }

// impl RequestContext for RequisitosContext {
//     fn receive(reader: &mut impl AsyncRead) -> impl std::future::Future<Output = Result<Self, std::io::Error>> + Send + Sync {
//         reader.read();
//         Self {
//             tiempo_min: 5,
//             precision_min: 5
...
//     fn send(reader: &mut impl tokio::io::AsyncWrite, req: &Self) -> impl std::future::Future<Output = Result<(), std::io::Error>> + Send + Sync {
//         todo!()
//     }
// }
...
// impl Policy<RequisitosContext> for Requisitos {
//     async fn choose_target(&self, request: &Request<RequisitosContext>, endps: &Endpoints) -> Uuid {
...
//     fn choose_model<'a>(&self, request: &Request<RequisitosContext>, models: &'a [Model]) -> &'a Model {
